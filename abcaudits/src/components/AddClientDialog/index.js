...
export default connect({
  ...
  text: state`ClientPanel.client_dialog.text`,

  clientDialogSubmitted: signal`ClientPanel.clientDialogSubmitted`,
  clientDialogCancelled: signal`ClientPanel.clientDialogCancelled`,
  textChanged: signal`ClientPanel.textChanged`,
},
